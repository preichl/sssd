                                   ...
                                   struct proxy_auth_ctx **_auth_ctx)
{
    ...
    ret = sss_hash_create(auth_ctx, auth_ctx->max_children * 2,
                          &auth_ctx->request_table);
    if (ret != EOK) {
                           ...
                           struct dp_method *dp_methods)
{
    ...
    dp_set_method(dp_methods, DPM_ACCOUNT_HANDLER, NULL, NULL, ctx,
                  struct proxy_id_ctx, void, struct dp_reply_std);
