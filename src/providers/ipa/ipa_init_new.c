                         ...
                         struct dp_method *dp_methods)
{
    ...
    dp_set_method(dp_methods, DPM_ACCOUNT_HANDLER, NULL, NULL, id_ctx,
                  struct ipa_id_ctx, void, struct dp_reply_std);
                             ...
                             struct dp_method *dp_methods)
{
    ...
    return ipa_autofs_init(mem_ctx, be_ctx, id_ctx, dp_methods);
    */
    return ENOTSUP;
#else
