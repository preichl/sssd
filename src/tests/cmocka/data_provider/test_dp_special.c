...
static void test_deny_handler(void **state)
{
    ...
    params = mock_dp_req_params(test_ctx, test_ctx->be_ctx,
                                NULL,
                                DPT_ID,
                                DPM_ACCOUNT_HANDLER);
    ...
    req = dp_access_deny_handler_send(test_ctx, NULL, pd, params);
    assert_non_null(req);
...
static void test_permit_handler(void **state)
{
    ...
    req = dp_access_permit_handler_send(test_ctx, NULL, pd, params);
    assert_non_null(req);
